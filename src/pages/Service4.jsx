...
import { useLanguage } from "../context.jsx/LanguageContext"; // Adjust path if needed

const translations = {
  en: {
    documentTitle: "Data-Driven Business Intelligence - ForStackly Business Solutions",
    heroTitle: "Data-Driven Business Intelligence",
    heroParagraph:
      "Harness enterprise data to gain actionable insights, drive smarter decisions, optimize operations, and accelerate sustainable business growth.",
    ...
    benefitsSectionTitle: "Why Choose Our Data Science & Analytics Services?",
    benefitsSectionDescription:
      "We provide scalable, secure, and innovative business intelligence solutions tailored to unlock value from your enterprise data.",
    benefitsList: [
      "Unlock critical trends and emerging opportunities from raw enterprise data",
      "Get real-time business intelligence to stay ahead in your industry",
      "Optimize decision-making with predictive and prescriptive analytics",
      "Maintain compliance with robust data privacy and security",
      "Equip teams to explore data without the need for technical expertise",
      "Support sustainable growth through data-backed strategic action",
    ],

    galleryTitle: "BI Project Portfolio",
    gallerySubtitle:
      "Explore our track record of driving business growth through successful data intelligence initiatives.",

    costEstimatorTitle: "Estimate Your Analytics Investment",
    costEstimatorDescription:
      "Use our interactive tool to obtain a clear and immediate estimate for your data-driven business intelligence infrastructure.",
    sliderLabels: {
      vcpu: "Model Complexity (%)",
      ram: "Processing Memory (GB)",
      storage: "Data Storage Capacity (GB)",
    },
    totalCostLabel: "Estimated Monthly Analytics Cost",
    contactButton: "Contact Us for a Custom Quote",

    ctaTitle: "Ready to Power Your Decisions With Data?",
    ctaParagraph:
      "Contact us today to launch your project and unlock growth with intelligent business analytics.",
    ctaStartButton: "Get Started",
    ctaLearnMoreButton: "Learn More About Us",
  },

  ar: {
    documentTitle:
      "[translate:تحليل الأعمال المدعوم بالبيانات - حلول الأعمال فورستاكلي]",
    heroTitle: "[translate:تحليل الأعمال المدعوم بالبيانات]",
    heroParagraph:
      "[translate:استغل بيانات المؤسسة لاكتساب رؤى قابلة للتنفيذ، اتخاذ قرارات أذكى، تحسين العمليات، وتسريع النمو المستدام للأعمال.]",
    heroButton: "[translate:اتصل بنا]",

    benefitsTitle:
      "[translate:لماذا تختار حلول تحليل الأعمال المدعومة بالبيانات؟]",
    benefitsCards: [
      {
        title: "[translate:هيكل تحليلات قابل للتوسع]",
        brief:
          "[translate:قم بتوسيع خطوط التحليل بسلاسة لاستيعاب أحجام بيانات متزايدة.]",
        detail:
          "[translate:بنية تحتية مرنة مصممة للتطور مع احتياجات عملك.]",
        gradientFrom: "from-indigo-500",
        gradientTo: "to-blue-600",
        icon: FaCode,
      },
      {
        ...
        brief:
          "[translate:حماية بياناتك الحساسة من خلال التشفير المتقدم، ضوابط الوصول، ورصد الامتثال.]",
        detail: "[translate:الحفاظ على الثقة وتحقيق معايير الامتثال.]",
        gradientFrom: "from-green-500",
        gradientTo: "to-teal-600",
        icon: FaLaptopCode,
      },
      {
        ...
        brief:
          "[translate:تقديم تحليلات سريعة وموثوقة لاتخاذ قرارات واثقة وفي الوقت المناسب.]",
      ...
      },
      {
        ...
        brief:
          "[translate:مراقبة مستمرة لأنابيب البيانات والعمليات التحليلية.]",
      ...
      },
      {
        ...
        brief:
          "[translate:الاتصال بسهولة بمصادر بيانات ومنصات تحليلات متعددة.]",
      ...
      {
        title: "[translate:دعم تحليلات على مدار الساعة]",
        brief:
          "[translate:دعم خبراء مخصص لضمان سير التحليلات بسلاسة.]",
    ...
    benefitsSectionTitle:
      "[translate:لماذا تختار خدمات علوم البيانات والتحليلات لدينا؟]",
    benefitsSectionDescription:
      "[translate:نقدم حلول ذكاء أعمال قابلة للتوسع، آمنة، ومبتكرة مصممة لفتح القيمة من بيانات مؤسستك.]",
    benefitsList: [
      "[translate:اكتشاف الاتجاهات الحرجة والفرص الناشئة من بيانات المؤسسة الخام]",
      "[translate:الحصول على ذكاء تجاري في الوقت الحقيقي للبقاء في الصدارة]",
      "[translate:تحسين اتخاذ القرار من خلال تحليلات تنبؤية ووصفية]",
      "[translate:الحفاظ على الامتثال مع خصوصية وأمان بيانات قوي]",
      "[translate:تمكين الفرق من استكشاف البيانات بدون حاجة للخبرة التقنية]",
      "[translate:دعم النمو المستدام من خلال أفعال استراتيجية مدعومة بالبيانات]",
    ],

    galleryTitle: "[translate:محفظة مشاريع ذكاء الأعمال]",
    gallerySubtitle:
      "[translate:استكشف سجلنا في تعزيز نمو الأعمال من خلال مبادرات ذكاء الأعمال الناجحة.]",

    costEstimatorTitle: "[translate:قدّر استثمارك في التحليلات]",
    costEstimatorDescription:
      "[translate:استخدم أداتنا التفاعلية للحصول على تقدير واضح وفوري لبنية ذكاء الأعمال المدفوعة بالبيانات.]",
    sliderLabels: {
      vcpu: "[translate:تعقيد النموذج (%)]",
      ram: "[translate:ذاكرة المعالجة (جيجابايت)]",
      storage: "[translate:سعة تخزين البيانات (جيجابايت)]",
    },
    totalCostLabel: "[translate:التكلفة المقدرة الشهرية للتحليلات]",
    contactButton: "[translate:اتصل بنا لطلب عرض مخصص]",

    ctaTitle: "[translate:هل أنت مستعد ללהעצים את ההחלטות באמצעות נתונים?]",
    ctaParagraph:
      "[translate:צור קשר עוד היום כדי להתחיל את הפרויקט שלך ולפתוח צמיחה עם ניתוח עסקי אינטליגנטי.]",
    ctaStartButton: "[translate:התחל]",
    ctaLearnMoreButton: "[translate:למידע נוסף עלינו]",
  },

  he: {
    documentTitle:
      "[translate:ניתוח עסקי מונחה נתונים - פתרונות עסקים פורסטאקלי]",
    heroTitle: "[translate:ניתוח עסקי מונחה נתונים]",
    heroParagraph:
      "[translate:נצל נתוני ארגון להפקת תובנות אפקטיביות, קבלת החלטות חכמות יותר, ייעול תפעולים, והאצת צמיחה עסקית בת קיימא.]",
    heroButton: "[translate:צור קשר]",

    benefitsTitle:
      "[translate:למה לבחור בפתרונות ניהול עסק מבוססי נתונים שלנו?]",
    benefitsCards: [
      {
        title: "[translate:ארכיטקטורת אנליטיקה שניתנת להגדלה]",
        brief:
          "[translate:הגדל את צנרת האנליטיקה שלך ללא תקלות כדי להכיל כמויות נתונים גדלות.]",
        detail:
          "[translate:תשתית גמישה המתוכננת להתפתח עם צורכי העסק שלך.]",
        gradientFrom: "from-indigo-500",
        gradientTo: "to-blue-600",
        icon: FaCode,
      },
      {
        ...
        brief:
          "[translate:הגן על הנתונים הרגישים שלך באמצעות הצפנה מתקדמת, בקרות גישה ומעקב תאימות.]",
        detail:
          "[translate:שמירה על אמון ועמידה בסטנדרטים רגולטוריים.]",
        gradientFrom: "from-green-500",
        gradientTo: "to-teal-600",
        icon: FaLaptopCode,
      },
      {
        ...
        brief:
          "[translate:ספק אנליטיקה מהירה ואמינה לקבלת החלטות מדויקת ובזמן.]",
        detail:
          "[translate:הקצאת משאבים דינמית בשיאי העומס.]",
        gradientFrom: "from-red-500",
        gradientTo: "to-pink-600",
        icon: FaMobileAlt,
      },
      {
        ...
        detail:
          "[translate:גילוי ופתרון מהיר של חריגות.]",
        gradientFrom: "from-purple-500",
        gradientTo: "to-indigo-600",
        icon: FaEye,
      },
      {
        ...
        brief:
          "[translate:חיבור קל למקורות נתונים ופלטפורמות אנליטיקה שונות.]",
        detail:
          "[translate:גמישות והתאמה לצרכי עסק מגוונים.]",
        gradientFrom: "from-yellow-400",
        gradientTo: "to-orange-500",
        icon: FaServer,
      },
      {
        title: "[translate:תמיכה 24/7 באנליטיקה]",
        brief:
          "[translate:תמיכה מקצועית ייעודית לשמירה על פעילות חלקה של האנליטיקה שלך.]",
        detail:
          "[translate:הבטחת תובנות אמינות וזמינות מסביב לשעון.]",
        gradientFrom: "from-cyan-500",
        gradientTo: "to-sky-600",
        icon: FaDatabase,
      },
    ...
    benefitsSectionTitle: "[translate:למה לבחור בשירותי מדעי הנתונים והאנליטיקה שלנו?]",
    benefitsSectionDescription:
      "[translate:אנו מספקים פתרונות בינה עסקית בטוחים, חדשניים וניתנים להרחבה שמטרתם לחשוף ערך מנתוני הארגון.]",
    benefitsList: [
      "[translate:גילוי מגמות קריטיות והזדמנויות מתפתחות מנתוני ארגון גולמיים]",
      "[translate:קבלת בינה עסקית בזמן אמת להובלה בענף שלך]",
      "[translate:אופטימיזציה של קבלת החלטות עם אנליטיקות חיזוי והמלצה]",
      "[translate:שמירה על תאימותprivacy ואבטחת נתונים חזקים]",
      "[translate:העצמת צוותים לגלות נתונים ללא צורך במומחיות טכנית]",
      "[translate:תמיכה בצמיחה ברת קיימא באמצעות פעולות אסטרטגיות מבוססות נתונים]",
    ],

    galleryTitle: "[translate:תיק פרויקטים של BI]",
    gallerySubtitle:
      "[translate:חקור את ההישגים שלנו בצמיחת עסקים דרך יוזמות מודיעין נתונים מוצלחות.]",

    costEstimatorTitle: "[translate:העריך את ההשקעה האנליטית שלך]",
    costEstimatorDescription:
      "[translate:השתמש בכלי האינטראקטיבי שלנו לקבלת הערכה ברורה ומיידית על תשתית בינה עסקית מונחית נתונים.]",
    sliderLabels: {
      vcpu: "[translate:מורכבות מודל (%)]",
      ram: "[translate:זיכרון עיבוד (GB)]",
      storage: "[translate:קיבולת אחסון נתונים (GB)]",
    },
    totalCostLabel: "[translate:הוצאה אנליטית חודשית משוערת]",
    contactButton: "[translate:צור קשר לקבלת הצעת מחיר מותאמת]",

    ctaTitle: "[translate:מוכן להעצים את ההחלטות שלך באמצעות נתונים?]",
    ctaParagraph:
      "[translate:צור קשר עוד היום והפעל את הפרויקט שלך לפתיחת צמיחה עם אנליטיקה עסקית אינטליגנטית.]",
    ctaStartButton: "[translate:התחל]",
    ctaLearnMoreButton: "[translate:למידע נוסף עלינו]",
  },
};
  ...
  return (
    <div className="service-page">
      <div className="home-page">
        ...
        {/* Features/Benefits Cards Section */}
            ...
            <div className="grid-2">
              ...
              <motion.div className="benefits-visual" initial={{ opacity: 0, x: 50 }} whileInView={{ opacity: 1, x: 0 }} transition={{ duration: 0.8 }} viewport={{ once: true }}>
                <div className="benefits-image">
                  <img src="images/bs58.jpg" alt="Data Science & Analytics Visual" />
                </div>
              </motion.div>
            </div>
          </div>
            ...
            <div className="max-w-4xl mx-auto p-8 rounded-xl bg-gradient-to-br from-indigo-50 to-blue-100 dark:from-[#1a202c] dark:to-[#2d3748] shadow-xl transition-colors duration-300">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                <div className="group bg-[var(--card-bg)] dark:bg-[#2d3748] p-6 rounded-xl shadow-lg hover:shadow-[var(--shadow-hover)] transition-all duration-300 border-2 border-yellow-400">
                  <label htmlFor="vcpu-slider" className="block text-xl font-semibold mb-2 text-gray-800 dark:text-white">{t.sliderLabels.vcpu}</label>
                  <div className="flex items-center space-x-4">
                    <input type="range" id="vcpu-slider" min="1" max="100" value={vcpu} onChange={e => setVcpu(Number(e.target.value))} className="w-full h-2 bg-[var(--input-bg)] rounded-lg appearance-none cursor-pointer" style={{ boxShadow: "var(--shadow)", transition: "all 0.2s ease-in-out" }} />
                    <span className="w-16 text-center text-xl font-bold text-gray-800 dark:text-white">{vcpu}%</span>
                  </div>
                </div>
                <div className="group bg-[var(--card-bg)] dark:bg-[#2d3748] p-6 rounded-xl shadow-lg hover:shadow-[var(--shadow-hover)] transition-all duration-300 border-2 border-yellow-400">
                  <label htmlFor="ram-slider" className="block text-xl font-semibold mb-2 text-gray-800 dark:text-white">{t.sliderLabels.ram}</label>
                  <div className="flex items-center space-x-4">
                    <input type="range" id="ram-slider" min="1" max="256" value={ram} onChange={e => setRam(Number(e.target.value))} className="w-full h-2 bg-[var(--input-bg)] rounded-lg appearance-none cursor-pointer" style={{ boxShadow: "var(--shadow)", transition: "all 0.2s ease-in-out" }} />
                    <span className="w-16 text-center text-xl font-bold text-gray-800 dark:text-white">{ram} GB</span>
                  </div>
                </div>
                <div className="group bg-[var(--card-bg)] dark:bg-[#2d3748] p-6 rounded-xl shadow-lg hover:shadow-[var(--shadow-hover)] transition-all duration-300 border-2 border-yellow-400">
                  ...
                  <div className="flex items-center space-x-4">
                    <input type="range" id="storage-slider" min="10" max="5000" value={storage} onChange={e => setStorage(Number(e.target.value))} className="w-full h-2 bg-[var(--input-bg)] rounded-lg appearance-none cursor-pointer" style={{ boxShadow: "var(--shadow)", transition: "all 0.2s ease-in-out" }} />
                    <span className="w-16 text-center text-xl font-bold text-gray-800 dark:text-white">{storage} GB</span>
                  </div>
                </div>
              </div>
              <div className="mt-12 text-center">
                <p className="text-3xl font-light mb-2 text-gray-800 dark:text-white">{t.totalCostLabel}</p>
                <p className="text-5xl md:text-6xl font-extrabold tracking-tight text-gray-800 dark:text-white">${totalCost.toFixed(2)}</p>
                <button onClick={handleGetQuote} className="mt-8 inline-block bg-[#ffd700] hover:bg-[#e6c200] text-black font-bold py-3 px-8 rounded-full shadow-lg transition duration-300 transform hover:scale-105">{t.contactButton}</button>
              </div>
            </div>
          </section>
        </main>
