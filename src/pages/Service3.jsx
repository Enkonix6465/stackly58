...
const translations = {
  ...
  ar: {
    documentTitle: 'إدارة الأمن السيبراني والمخاطر - حلول الأعمال فورستاكلي',
    heroTitle: 'إدارة الأمن السيبراني والمخاطر',
    heroParagraph:
      'احمِ أعمالك باستراتيجيات أمن سيبراني شاملة، بما في ذلك استخبارات التهديدات، حماية خصوصية البيانات، وإدارة المخاطر المستمرة. حافظ على المرونة من خلال الدفاعات الاستباقية والحلول التي تلتزم بالتشريعات.',
    heroButton: 'اتصل بنا',

    benefitsTitle: 'لماذا تختار إدارة الأمن السيبراني والمخاطر لدينا؟',
    benefitsCards: [
      {
        title: 'حماية متقدمة من التهديدات',
        brief: 'دفاع مستمر ضد التهديدات السيبرانية والبرمجيات الخبيثة المتطورة.',
        detail: 'حماية أعمالك على مدار 24/7 مع الصيد الذكي للتهديدات والاستجابة للحوادث.',
        gradientFrom: 'from-indigo-500',
        gradientTo: 'to-blue-600',
        icon: FaShieldAlt,
      },
      {
        title: 'تشفير البيانات والخصوصية',
        brief: 'حماية المعلومات السرية في أي مكان بيئتك.',
        detail: 'ضمان الالتزام وحماية البيانات الحساسة عبر نقاط النهاية والسحابة.',
        gradientFrom: 'from-green-500',
        gradientTo: 'to-teal-600',
        icon: FaLock,
      },
      {
        title: 'التحكم في الوصول وإدارة الهوية',
        brief: 'التأكد من وصول المستخدمين المناسبين للموارد الصحيحة فقط.',
        detail: 'سياسات قوية والمصادقة متعددة العوامل لتأمين مؤسستك.',
        gradientFrom: 'from-red-500',
        gradientTo: 'to-pink-600',
        icon: FaUserSecret,
      },
      {
        title: 'تقييم الثغرات الأمنية',
        brief: 'تحديد المخاطر قبل أن تتحول لمشاكل من خلال الفحوصات الأمنية الروتينية.',
        detail: 'الفحص المستمر والمعالجة لسد الثغرات الأمنية.',
        gradientFrom: 'from-purple-500',
        gradientTo: 'to-indigo-600',
        icon: FaBug,
      },
      {
        title: 'أمن الشبكات ونقاط النهاية',
        brief: 'جدران حماية، المراقبة، والمعالجة للأجهزة والشبكات.',
        detail: 'طبقات حماية شاملة تحمي بنيتك التحتية من الهجمات.',
        gradientFrom: 'from-yellow-400',
        gradientTo: 'to-orange-500',
        icon: FaNetworkWired,
      },
      {
        title: 'الامتثال والتنظيم والتقارير',
        brief: 'ابقَ مستعدًا للتدقيق من خلال أطر الامتثال والتقارير المخصصة.',
        detail: 'تبسيط شهاداتك والالتزام بالتنظيمات.',
        gradientFrom: 'from-cyan-500',
        gradientTo: 'to-sky-600',
        icon: FaClipboardCheck,
      },
    ...
    benefitsSectionTitle: 'حلول الأمن السيبراني وإدارة المخاطر',
    benefitsSectionDescription:
      'نقدم استراتيجيات أمنية متعددة المستويات من الجيل التالي تُبقي الأعمال مرنة ومتوافقة وآمنة ضد المخاطر المعقدة.',
    benefitsList: [
      'أفضل حماية ضد الهجمات السيبرانية',
      'الكشف المبكر عن التهديدات والاستجابة السريعة للحوادث',
      'الامتثال للمعايير الصناعية والتنظيمية',
      'وصول آمن للمستخدم وإدارة هوية قوية',
      'مراقبة 24/7 من متخصصين معتمدين في الأمن السيبراني',
      'تسعير شفاف لعمليات الأمن القابلة للتوسع',
    ],

    galleryTitle: 'محفظة مشاريع الأمن السيبراني',
    gallerySubtitle:
      'استكشف عمليات نشر حلول الأمن السيبراني وإدارة المخاطر التي نفذناها للعملاء حول العالم.',

    costEstimatorTitle: 'قدّر تكاليف الأمن السيبراني',
    costEstimatorDescription:
      'استخدم أداتنا التفاعلية لتقدير ميزانيتك للحماية، والرصد، والامتثال بناءً على عدد نقاط النهاية والمستخدمين وحجم تخزين الحوادث.',
    sliderLabels: {
      vcpu: 'نقاط النهاية المحمية',
      ram: 'حسابات المستخدمين المراقبة',
      storage: 'تخزين سجلات الحوادث (جيجا بايت)',
    },
    totalCostLabel: 'ميزانية الأمن السيبراني الشهرية المقدرة',
    contactButton: 'اتصل بنا لعرض سعر مخصص',

    ctaTitle: 'هل أنت مستعد لتعزيز الأمن السيبراني لديك؟',
    ctaParagraph:
      'شراكة معنا للدفاع عن عملك، وتحقيق الامتثال، والاستجابة السريعة للمخاطر الرقمية بحلول أمنية وإدارية رائدة عالمياً.',
    ctaStartButton: 'اطلب استشارة أمنية',
    ctaLearnMoreButton: 'تعرف أكثر على الدفاع السيبراني',
  },

  he: {
    documentTitle: 'ניהול אבטחת סייבר וסיכונים - פתרונות עסקיים פורסטאקלי',
    heroTitle: 'ניהול אבטחת סייבר וסיכונים',
    heroParagraph:
      'הגן על העסק שלך עם אסטרטגיות אבטחה מקיפות, כולל מודיעין איומים, הגנות פרטיות נתונים, וניהול סיכונים מתמשך. שמור על חוסן עם הגנות פרואקטיביות ופתרונות תואמי תקנות.',
    heroButton: 'צור קשר',

    benefitsTitle: 'למה לבחור בניהול אבטחת סייבר וסיכונים שלנו?',
    benefitsCards: [
      {
        title: 'הגנה מתקדמת מפני איומים',
        brief: 'הגנה רציפה מפני איומי סייבר ומאלוורים מתפתחים.',
        detail: 'הגנת העסק שלך 24/7 עם איתור איומים ותגובה לאירועים חכמה.',
        gradientFrom: 'from-indigo-500',
        gradientTo: 'to-blue-600',
        icon: FaShieldAlt,
      },
      {
        title: 'הצפנת נתונים ופרטיות',
        brief: 'הגן על מידע סודי בכל מקום בסביבתך.',
        detail: 'מבטיח תאימות ומגנים על נתונים רגישים בנקודות קצה ובענן.',
        gradientFrom: 'from-green-500',
        gradientTo: 'to-teal-600',
        icon: FaLock,
      },
      {
        title: 'שליטה בגישה וניהול זהויות',
        brief: 'ודא שמשתמשים נכונים ניגשים למשאבים הנכונים בלבד.',
        detail: 'מדיניות חזקה ואימות דו-שלבי לאבטחת הארגון שלך.',
        gradientFrom: 'from-red-500',
        gradientTo: 'to-pink-600',
        icon: FaUserSecret,
      },
      {
        title: 'הערכת פגיעויות',
        brief: 'זיהוי סיכונים לפני שהם הופכים לבעיות באמצעות סריקות אבטחה שגרתיות.',
        detail: 'סריקה מתמשכת ותיקון פגיעויות.',
        gradientFrom: 'from-purple-500',
        gradientTo: 'to-indigo-600',
        icon: FaBug,
      },
      {
        title: 'אבטחת רשת ונקודות קצה',
        brief: 'חומות אש, ניטור ותגובה למכשירים ורשתות.',
        detail: 'שכבות הגנה מקיפות המגנות על התשתית שלך מפני התקפות.',
        gradientFrom: 'from-yellow-400',
        gradientTo: 'to-orange-500',
        icon: FaNetworkWired,
      },
      {
        title: 'ציות ודו״חות רגולטוריים',
        brief: 'הישאר מוכן לבדיקה עם מסגרות ודוחות מותאמים אישית.',
        detail: 'פישוט תהליכי אישור ועמידה בתקנות.',
        gradientFrom: 'from-cyan-500',
        gradientTo: 'to-sky-600',
        icon: FaClipboardCheck,
      },
    ...
    benefitsSectionTitle: 'פתרונות אבטחת סייבר וניהול סיכונים',
    benefitsSectionDescription:
      'אנו מציעים אסטרטגיות אבטחה רב-שכבתיות מדור הבא לשמירה על עסק עמיד, תואם ובטוח מפני סיכונים מורכבים.',
    benefitsList: [
      'הגנה מתקדמת מפני התקפות סייבר',
      'איתור איומים פרואקטיבי ותגובה מהירה לאירועים',
      'עמידה בתקנים ורגולציות בתעשייה',
      'גישה מאובטחת וניהול זהויות חזק',
      'ניטור 24/7 על ידי מומחים מוסמכים',
      'תמחור שקוף לתפעול אבטחה מדרגית',
    ],

    galleryTitle: 'פורטפוליו פרויקטי אבטחה',
    gallerySubtitle:
      'חקור פריסות אחרונות של פתרונות אבטחת סייבר וניהול סיכונים ללקוחות ברחבי העולם.',

    costEstimatorTitle: 'הערך את עלויות אבטחת הסייבר שלך',
    costEstimatorDescription:
      'השתמש בכלי האינטראקטיבי שלנו להערכת התקציב שלך לאבטחה, ניטור וציות לפי נקודות קצה, משתמשים ואחסון אירועים.',
    sliderLabels: {
      vcpu: 'נקודות קצה מוגנות',
      ram: 'חשבונות משתמשים מנוטרים',
      storage: 'אחסון יומני אירועים (גיגה-בייט)',
    },
    totalCostLabel: 'תקציב אבטחת הסייבר החודשי המשוער',
    contactButton: 'צור קשר לקבלת הצעת מחיר מותאמת',

    ctaTitle: 'מוכן לחיזוק אבטחת הסייבר שלך?',
    ctaParagraph:
      'שיתוף פעולה איתנו להגנה על העסק שלך, השגת תאימות ותגובה מהירה לסיכונים דיגיטליים עם פתרונות אבטחה וניהול סיכונים מהשורה הראשונה.',
    ctaStartButton: 'בקש ייעוץ אבטחה',
    ctaLearnMoreButton: 'למד עוד על הגנת סייבר',
  },
};
          ...
          <section className="py-16 md:py-4 bg-[var(--bg-color)] rounded-xl shadow-2xl my-12 text-[var(--text-color)] transition-colors" style={{ boxShadow: 'var(--shadow)' }}>
            ...
            <div className="max-w-4xl mx-auto p-8 rounded-xl bg-gradient-to-br from-indigo-50 to-blue-100 dark:from-[#1a202c] dark:to-[#2d3748] shadow-xl transition-colors">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="group bg-[var(--card-bg)] dark:bg-[#2d3748] p-6 rounded-xl shadow-lg hover:shadow-[var(--shadow-hover)] border-2 border-yellow-400">
              ...
              <div className="mt-12 text-center">
                ...
                <button onClick={handleGetQuote} className="mt-8 px-8 py-3 rounded-full bg-[#ffd700] hover:bg-[#e6c200] text-black font-bold shadow transition duration-300">{t.contactButton}</button>
              </div>
            </div>
          </section>
        </main>
